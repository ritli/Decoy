...
public class AudioFootsteps : MonoBehaviour {
	...
	void Start () {
        m_stepEmitter = transform.Find("Step").GetComponent<FMODUnity.StudioEventEmitter>();
        m_landEmitter = transform.Find("Land").GetComponent<FMODUnity.StudioEventEmitter>();
    }
