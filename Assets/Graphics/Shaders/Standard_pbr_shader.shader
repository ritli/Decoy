...
///////// Gloss:
                ...
                float gloss = 1.0 - (_RoughnessTexture_var.a*_Roughness); // Convert roughness to gloss
                float perceptualRoughness = (_RoughnessTexture_var.a*_Roughness);
...
////// Specular:
                ...
                float3 specularColor = (_Metalictexture_var.a*_Metallic);
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float3 specColor;
                float4 _Metalictexture_var = tex2D(_Metalictexture,TRANSFORM_TEX(i.uv0, _Metalictexture));
                diffColor = DiffuseAndSpecularFromMetallic( diffColor, (_Metalictexture_var.a*_Metallic), specColor, specularMonochrome );
                float4 _RoughnessTexture_var = tex2D(_RoughnessTexture,TRANSFORM_TEX(i.uv0, _RoughnessTexture));
                float roughness = (_RoughnessTexture_var.a*_Roughness);
